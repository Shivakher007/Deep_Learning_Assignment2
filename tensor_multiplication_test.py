...
def test_neuron():
    ...
    assert torch.allclose(calculate_activation(torch.tensor(0.0)), torch.tensor(0.0)), "wrong activation"
    assert torch.allclose(calculate_activation(torch.tensor(0.1)), torch.tensor(1.0)), "wrong activation"
    assert torch.allclose(calculate_activation(torch.tensor(-0.1)), torch.tensor(0.0)), "wrong activation"
